...
public class CalculatorClient {
    ...
    public static void main(String[] args) {
        ...
        //Divide
        int division = normalCalc.divide(45, 15);
        System.out.println("3) Division result is " + division);

        //Subtract
        int subtract = normalCalc.subtract(33, 11);
        System.out.println("4) Subtraction result is " + subtract);
